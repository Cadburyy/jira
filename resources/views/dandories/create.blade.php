            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="requestor" class="form-control" value="{{ Auth::user()->name }}" required readonly>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="line_production" class="form-control" placeholder="Line Produksi" value="{{ old('line_production') }}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="nama_part" class="form-label"><strong>Nama Part:</strong></label>
                        <input type="text" name="nama_part" class="form-control" placeholder="Nama Part" value="{{ old('nama_part') }}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="nomor_part" class="form-label"><strong>Nomor Part:</strong></label>
                        <input type="text" name="nomor_part" class="form-control" placeholder="Nomor Part" value="{{ old('nomor_part') }}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="proses" class="form-label"><strong>Proses:</strong></label>
                        <input type="text" name="proses" class="form-control" placeholder="Proses" value="{{ old('proses') }}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="mesin" class="form-label"><strong>Mesin:</strong></label>
                        <input type="text" name="mesin" class="form-control" placeholder="Mesin" value="{{ old('mesin') }}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="qty_pcs" class="form-label"><strong>Qty. PCS:</strong></label>
                        <input type="number" name="qty_pcs" class="form-control" placeholder="Qty. PCS" value="{{ old('qty_pcs') }}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
